 ...
 */
#ifdef configMORE_POWER
	#if ( configMORE_POWER == 1 )
	/*
	...
	typedef tskTCB OSTCB_t;
	typedef List_t OSList_t;
	typedef tskTCB * OSTaskHandle_t;

	OSList_t *pxOSGetReadyTasksHandle( void ) PRIVILEGED_FUNCTION;
	OSList_t *pxOSGetDelayedTasksHandle( void ) PRIVILEGED_FUNCTION;
	OSList_t *pxOSGetSuspendedTasksHandle( void ) PRIVILEGED_FUNCTION;
	OSTCB_t *pxOSGetCurrentTCBHandle( void ) PRIVILEGED_FUNCTION;
