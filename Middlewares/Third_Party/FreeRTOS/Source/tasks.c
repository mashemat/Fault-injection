 ...
 */
	...
	OSList_t *pxOSGetReadyTasksHandle( void )
	{
		return (OSList_t*)&pxReadyTasksLists;
	}
	OSList_t *pxOSGetDelayedTasksHandle( void )
	{
		return (OSList_t*)&xDelayedTaskList1;
	}
	OSList_t *pxOSGetSuspendedTasksHandle( void )
	{
		return (OSList_t*)&xSuspendedTaskList;
	}
	OSTCB_t *pxOSGetCurrentTCBHandle( void )
	{
		return (OSTCB_t*)&pxCurrentTCB;
	}
